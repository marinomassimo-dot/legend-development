...
- AAV9-hSynI-hWWOX: dose-dependent, durable rescue in the Wwox-null murine model, including ECoG/SWD reduction (Obeid 2026).
...
- Obeid 2026 (Wwox-null murine model): AAV9-hSynI-hWWOX — neuron-specific targeting, dose calibration, early postnatal window → dose-dependent durable rescue on survival, growth, glucose, behaviour, myelination, gliosis, SWD/ECoG.
...
| 004 | AAV9-WWOX neuron-targeted multi-domain rescue in vivo | DATO | P7 | T2 | consolidated baseline | Repudi 2021 *EMBO* |
...
| 011 | AAV9-hSynI-hWWOX: dose-dependent durable rescue in the Wwox-null model (survival, ECoG/SWD, myelination, gliosis) | DATO (preclinical) | P7 | T2 | consolidated baseline (full text) | Obeid 2026 |
...
- **Obeid 2026 (Wwox-null murine model):** AAV9-hSynI-hWWOX — dose-dependent, durable rescue on survival, glucose, behaviour, myelination, gliosis, SWD/ECoG; neuron-specific targeting; early postnatal ICV delivery. P7 design principles are now defined preclinically.
