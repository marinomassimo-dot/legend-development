...
**Version:** WM_v5.1_2026-09-26
**Date baseline:** 2026-03-28
**Last update:** 2026-09-26 — `BATCH_20260926_ALDAZ` (**MINOR**): two `consolidated baseline` claims on the P47T knock-in (PMID 36828035) are **narrowed to what the complete reading and a three-round blind locator audit support**, and both stay `consolidated baseline`. `CLAIM 006`: hippocampal astrogliosis rises with age; microglial progression is shown for **morphology only**, and progression of microglial **abundance is untested, not shown to be absent**; the statistics are pseudoreplicated (subfields or cells of n = 3 mice), and with only two time points the data give a direction, not a rate. `CLAIM 007`: WWOX recovery by **two PPPY oligopeptides** in one cerebellar pull-down at n = 2 is abolished or near-abolished — not "PPxY binding to WW-domain partners"; transcript is unchanged in four regions, and protein abundance is neither shown unchanged nor shown reduced. `PAPER 007` gets its real identity (it had an invented title and no identifier); `PAPER 112`, registered earlier the same day by `BATCH_20260926_ALDAZ_R1` from the same reading, is kept append-only as its duplicate. The mirror rows moved with the claims. **No reversal, no BLOCCO 1 change, no therapeutic recommendation; P47T ≠ Q230P is unchanged.**
**Last update:** 2026-09-22 — `BATCH_20260922_SEIZURE` (**MAJOR — operator-authorized**): the seizure/epileptogenesis statements reconciled across five claims. **`CLAIM 037`'s headline clause *«explicitly absent in Wwox-null mice»* is DELETED as false** against four verified first-hand datasets; **`CLAIM 005`'s prohibition is RETARGETED, not deleted** — it now bans asserting *epileptogenesis as a process* (which nobody has measured, in any model) instead of banning description of the animal, which three canonical claims already do. **`CLAIM 040` added** (neuronal WWOX restoration suppresses SWD to `ns` versus WT). `CLAIM 016` gains a cross-reference and a floor-not-a-rate caveat. **Four axes are kept separate throughout: spontaneous seizures · provoked susceptibility · susceptibility as a threshold · formal epileptogenesis — the last remains UNMEASURED in every WWOX model.** `NOT_REPORTED ≠ ABSENT` preserved and dated. **No BLOCCO 1 change, no therapeutic recommendation, no claim about EEG normality anywhere else, and no generalisation across alleles or species.**
**Last update:** 2026-09-21 — `BATCH_20260921_001` (**MINOR**): four operator-approved candidates propagated with narrowings. Two canonical absolutes were retired in favour of what their sources measure — *haploinsufficiency is not deleterious* is now bounded by its endpoint class, and *proteina assente* is now *proteina non rilevata*. `CLAIM 039`'s cerebellar limb now states that **neither evidence stream establishes nor excludes** a cerebellar contribution. **The mirror rows moved with the claims this time** — which is the defect the previous last-update note recorded.
...
| 032 | **Haploinsufficiency is not deleterious on the endpoints measured** (neoplasia, lifespan, growth, gross morphology): the therapeutic threshold sits well below full restoration **for those endpoints** — 🔴 `PREMISE: NOBODY_LOOKED` on cognition, EEG and network excitability | INFERENZA | P7 / threshold | T2 | in observation | BATCH_20260710_A synthesis |
...
| 037 | Seizure-related phenotypes in WWOX rodent models are documented in the rat `lde/lde` (audiogenic + EEG), in the **Wwox-null mouse** (behavioural since 2020, electrographic since 2026) and in the **`P47T` knock-in** (video-EEG, adult); the **audiogenic/kindling** phenotype remains rat-specific | DATO | P2 excitability | T2 vulnerability / T3 phenotype transfer | in observation | PAPER 058 + PAPER 059 (rat) + PMID 32000863 (mouse null, behavioural + provoked) + PMID 42422765 (mouse null, ECoG) + PMID 36828035 (`P47T`, video-EEG) |
...
|------|---------|--------|--------|-----------|
| 2026-09-26 | **WM_v5.1** | **`BATCH_20260926_ALDAZ` (MINOR — narrowing of two `consolidated baseline` claims, R4 satisfied).** `CLAIM 006` title and summary bound to what Fig. 3–4 of PMID 36828035 test: astrogliosis progresses, microglial progression is morphological only, microglial abundance progression is untested; evidence boundary records pseudoreplication (n = 3 mice), two time points, no multiplicity correction, no declared blinding. `CLAIM 007` title and summary bound to two PPPY oligopeptides, one tissue, n = 2, with the authors' "failed to interact" beside an attested figure reading of one residual lane-discrete band; transcript unchanged in four regions; protein abundance unquantified. `PAPER 007` identity normalised; `PAPER 112` marked its duplicate; `LIT-0077` completed. Append-only notes on `DL-MECH-012`, `DL-BIO-085`, `DL-REPO-002`; `RL-NEUROINF-001`, `therapy_levers.md` §B2 and the `meta_gaba_paradox_current.md` line on `PAPER 007` aligned. Candidates: CC-20260826-CLAIM006-01 superseded, CC-20260826-CLAIM006-HARDENING-01 / CC-20260913-36828035-01 / CC-20260826-PROVENANCE-01 propagated in part, CC-20260826-PROVENANCE-PAPER007-01 propagated | Complete reading `FTR-20260913-36828035-03` + blind locator audit, rounds 1–3 of the four-round record | High for the narrowing; the remaining limits are the source's |
| 2026-09-22 | **WM_v5.0** | **`BATCH_20260922_SEIZURE` (MAJOR — operator-authorized, scope strictly limited to the seizure/epileptogenesis statements).** Five edits. 🔴 **`CLAIM 037` title:** *«…and it is explicitly absent in Wwox-null mice»* **deleted as false**; replaced by a statement that separates the rat `lde/lde` (audiogenic + EEG), the **Wwox-null mouse** (behavioural since PMID 32000863, electrographic since PMID 42422765) and the **`P47T` knock-in** (video-EEG, PMID 36828035), while **keeping the true part — the audiogenic/kindling phenotype is rat-specific**. 🔴 **`CLAIM 037` evidence boundary:** the old opener is replaced by a `NOT_REPORTED ≠ ABSENT` record — PMID 19500159 is a **literature survey over four papers none of which recorded**, and it predates the NCKU null; the clause *«i topi potrebbero morire prima di convulsionare»* is **deleted as falsified** (spontaneous seizures from P12 and SWDs at P14–21, both inside a lifespan of *«less than a month»*). **Every rat caveat is retained verbatim** — 95% female-only, 34% is a floor, vacuolisation unmatched, single laboratory, `PREMISE: DEFAULT_FROM_TEXTBOOK` on proteasomal turnover. 🔴 **`CLAIM 005`: the prohibition is RETARGETED rather than deleted** — deleting it would discard a guard that is still needed. It now bans asserting **epileptogenesis as a process** in any WWOX model, because no study has observed the transition longitudinally; `epileptogenesis` is **nomenclature** (PMID 32000863 uses it twice for *provoked susceptibility*; it appears **zero times** in PMID 42422765). Measured seizure and epileptiform phenotypes are explicitly declared recordable and cross-referenced. **`CLAIM 016`** gains a cross-reference plus the caveat that the spontaneous-seizure observation is **opportunistic husbandry plus one video — a floor, not a rate** — while the PTZ/pilocarpine arm is protocolled (Racine, 60 min, three genotypes). ⭐ **New `CLAIM 040`**: neuronal AAV9-hSynI-hWWOX restores SWD to `ns` versus WT (`n=5`/group, single channel, no recovery interval, P14–P21; the interictal-spike panel sits at the Mann–Whitney floor and is **not tested**; SWD is an absence-type signature, not a convulsive seizure). **What did NOT change:** BLOCCO 1, any therapeutic recommendation, `CLAIM 011`'s dose-axis flag, the rat dataset and its caveats, and the status of epileptogenesis as **unmeasured** | Operator authorization + four first-hand datasets verified against local manifests and, for PMID 32000863, against the retrieved body | High for the deletions and the retarget; bounded for `CLAIM 040` |
| 2026-08-15 | **WM_v4.3** | **BATCH_20260815_001 (MINOR):** 15 candidates propagated; 17 complete-read paper records added; PAPER 011/024/039 and CLAIM 009/011/032/034/036 corrected or qualified; one stale candidate recognized as already propagated; no baseline reversal | Integrated reading backlog and receipt-backed corrections | High for provenance; bounded by declared gaps |
...
| 2026-09-09 | **WM_v4.4** | **`BATCH_20260909_001` (MINOR).** Eighteen candidates from the Aqeilan 54-PMID free-full-text sweep propagated. Twelve PAPER records created (081–092), five corpus stubs promoted append-only, three corpus records read in place, `PAPER 010` and `PAPER 040` back-filled onto real receipts, seven LIT records created and eight completed. **`CLAIM 023` NARROWED** — an untested phosphorylation↔rerouting coupling removed from its title and from this mirror, `Status` unchanged, R4 blind audit satisfied. `CLAIM 002` gains a marker-selective cortical-layering boundary and two adjacent nulls; `CLAIM 017`, `CLAIM 019` gain the Banne 2021 genotype-level census with its own falsified generalisation flagged; `CLAIM 030` gains the codon-47 genotype-matching boundary and an independent but non-independent corroboration; `CLAIM 025`, `CLAIM 029`, `CLAIM 033`, `CLAIM 036` qualified. **No baseline reversed, no BLOCCO 1 change, no therapeutic promotion.** Deferred: `CC-20260909-25331887-01`. Routed to the dismissal ledger, not canonical: `CC-20260909-31428585-01` | Aqeilan sweep BATCH_COMMIT | High |
| 2026-09-21 | **WM_v4.5** | **`BATCH_20260921_001` (MINOR — 4 commit candidates propagated, operator-approved with narrowings).** No claim is reversed and no claim changes status. **`CLAIM 032`** stops asserting a general absence of phenotype: title, summary and the dose corollary now name the endpoint class actually measured (neoplasia, lifespan, growth, gross morphology, WB/IHC, clinical observation), and carry `PREMISE: NOBODY_LOOKED` on cognition, EEG and network excitability — **the state of the evidence is «insufficient for a general conclusion of no phenotype», not «no phenotype»**, and it still does not demonstrate disease in carriers. **`CLAIM 030`** aligns one row to its source and to the `consolidated baseline` `CLAIM 019`: *proteina assente* → *proteina non rilevata al Western blot*, `PREMISE: DETECTION_FLOOR`. **`CLAIM 039`** narrows the cerebellar limb to what the source supports and records that **neither evidence stream establishes nor excludes a cerebellar contribution**; it remains a rat-model claim and no human imaging material is imported. **`CORPUS-STUB-150` → `PAPER 096`** (PMID 34140629), a read paper closed at `T3` / `LOW` that deliberately generates no claim. The BLOCK 2 mirror rows for 032 and 039 moved with their claims. `D-17` was **deferred by the operator** and is not in this batch. |
