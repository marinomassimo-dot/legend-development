...
| Partial full text | 12 | 3% | some sections read; explicitly declared incomplete |
| Abstract / screened | 13 | 3% | classified from metadata and abstract; no full text read |
| Catalogued only | 337 | 79% | known, deduplicated, never analytically processed — **the debt** |
...
- **130** append-only events: **107** contemporaneous · **22** conservative legacy reconstructions
