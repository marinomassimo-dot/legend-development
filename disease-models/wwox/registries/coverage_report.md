...
|---|---:|---:|---|
| **Full text depth** | 78 | 18% | complete receipt or legacy registry declaration; trace split below |
...
| Catalogued only | 341 | 77% | known, deduplicated, never analytically processed — **the debt** |
| Filtered / superseded | 3 | 1% | explicitly set aside, with the reason preserved |

- **85** promoted `PAPER` records · **360** `CORPUS` placeholders
- **398** lifecycle entries in the literature tracking log
- **392** unique PMIDs known across the registries
...
- **65** registry records have a persisted `complete_fulltext_read` receipt
