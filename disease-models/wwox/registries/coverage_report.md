...
|---|---:|---:|---|
| **Full text depth** | 28 | 12% | complete receipt or legacy registry declaration; trace split below |
...
- **8** registry records have a persisted `complete_fulltext_read` receipt
