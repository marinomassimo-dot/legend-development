...
|---|---:|---:|---|
| **Full text depth** | 46 | 11% | complete receipt or legacy registry declaration; trace split below |
...
| Catalogued only | 340 | 83% | known, deduplicated, never analytically processed — **the debt** |
...
- **94** append-only events: **71** contemporaneous · **22** conservative legacy reconstructions
- **29** registry records have a persisted `complete_fulltext_read` receipt
