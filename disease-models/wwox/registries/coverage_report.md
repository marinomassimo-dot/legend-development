...
|---|---:|---:|---|
| **Full text depth** | 49 | 12% | complete receipt or legacy registry declaration; trace split below |
...
| Catalogued only | 337 | 82% | known, deduplicated, never analytically processed — **the debt** |
...
- **96** append-only events: **73** contemporaneous · **22** conservative legacy reconstructions
- **32** registry records have a persisted `complete_fulltext_read` receipt
