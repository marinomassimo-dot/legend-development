...
|---|---:|---:|---|
| **Full text depth** | 27 | 12% | complete receipt or legacy registry declaration; trace split below |
| Partial full text | 1 | 0% | some sections read; explicitly declared incomplete |
| Abstract / screened | 18 | 8% | classified from metadata and abstract; no full text read |
...
- **47** append-only events: **25** contemporaneous · **22** conservative legacy reconstructions
- **7** registry records have a persisted `complete_fulltext_read` receipt
- **20** records still rely on a historical registry full-text declaration without a surviving complete coverage receipt
- **6** receipt event(s) do not yet map to a registry record
