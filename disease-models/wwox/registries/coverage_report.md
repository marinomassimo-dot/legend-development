...
|---|---:|---:|---|
| **Full text depth** | 56 | 14% | complete receipt or legacy registry declaration; trace split below |
...
| Catalogued only | 328 | 80% | known, deduplicated, never analytically processed — **the debt** |
...
- **120** append-only events: **97** contemporaneous · **22** conservative legacy reconstructions
- **40** registry records have a persisted `complete_fulltext_read` receipt
