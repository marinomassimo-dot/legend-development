...
| Catalogued only | 341 | 76% | known, deduplicated, never analytically processed — **the debt** |
| Filtered / superseded | 3 | 1% | explicitly set aside, with the reason preserved |

- **85** promoted `PAPER` records · **361** `CORPUS` placeholders
...
- **8** receipt event(s) do not yet map to a registry record
