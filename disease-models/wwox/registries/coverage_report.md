...
| Catalogued only | 338 | 83% | known, deduplicated, never analytically processed — **the debt** |
...
- **98** append-only events: **75** contemporaneous · **22** conservative legacy reconstructions
