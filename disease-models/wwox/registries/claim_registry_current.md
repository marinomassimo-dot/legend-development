...
**Wording record (BATCH_20260926_MALLARET, 2026-09-26):** the P47T limb and the scope of the WW1 conclusion now carry what PMID 24369382 measures, in the wording a blind locator audit passed in four rounds (`research/locator_audits/2026-09-26_PMID24369382_blind_audit.md`): protein abundance judged by eye in one patient's fibroblasts, not quantified; binding lost to one PPPY peptide in vitro. The claim's conclusion, its cross-paper construction and its status are unchanged.
---
...
**(1) La classificazione è sintattica, non funzionale.** La classe è dedotta dal *tipo di lesione nel DNA*, mai dall'effetto misurato sulla proteina. Le nostre stesse fonti la falsificano come proxy: **Q230P** è missense e **azzera la proteina** ([[paper_registry_current#PAPER 041]]); **P47T** è missense, ha **proteina presente, di abbondanza simile ai controlli all'ispezione visiva (non quantificata)**, binding in vitro al peptide PPPY **perduto** in costrutti di fusione GST-WW, e un fenotipo SCAR12 che gli autori descrivono come **più lieve** dei modelli murino e di ratto ([[paper_registry_current#PAPER 042]]); **P47R** — stesso residuo — dà fenotipo **severo**. Dentro "missense" convivono almeno tre meccanismi distinti. Vedi [[claim_registry_current#CLAIM 030]].
