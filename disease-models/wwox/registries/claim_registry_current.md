...
**Source:** Obeid, Aqeilan et al. 2026, Molecular Therapy Advances (OMTA — *Mol Ther Adv*) vol 34 (peer-reviewed; versione published del preprint bioRxiv precedente — contenuto "dose-dependent durable rescue" identico nelle due versioni)
...
**Summary:** Confrontando cinque varianti (dati su cellule di paziente e saggi in vitro): **P47T** (WW1): **proteina presente** (*"still present, at least in human skin fibroblasts"*), di abbondanza simile ai controlli all'ispezione visiva (**non quantificata**); **binding in vitro al peptide PPPY perduto** in costrutti di fusione GST-WW (*"failed to interact"*); fenotipo **SCAR12** (pazienti della Famiglia 1, età 17-26 anni al 2014), che gli autori descrivono come *"milder"* rispetto ai modelli murino e di ratto e attribuiscono — *"presumably"* — a una perdita di funzione parziale: proteina ancora presente e dominio deidrogenasi/reduttasi presumibilmente ancora funzionale nella Famiglia 1. **P47R** — stesso residuo — dà fenotipo **severo**. **Q230P** (SDR) ha **proteina non rilevata al Western blot** → **severo**. `PREMISE: DETECTION_FLOOR` — *non rilevata* non è *assente*: la soglia dell'immunoblot non è misurata, e [[claim_registry_current#CLAIM 019]] (`consolidated baseline`) registra lo stesso dato come *proteina non rilevata*. La distinzione è biologicamente portante, perché *assente* chiude la possibilità di un pool residuo che una leva proteostatica cercherebbe di alzare, mentre *non rilevata* la lascia aperta. **G372R** (SDR) ha proteina quasi non rilevabile all'IF → **lieve**, con organoidi forebrain quasi normali. **p.Arg54\*** (null) → letale a 16 mesi. ⇒ **L'abbondanza di proteina non predice la severità.** Steinberg 2021 lo osserva indipendentemente: la severità potrebbe correlare con i *"functional levels"* di WWOX, non con quelli totali. La funzione di binding del dominio **WW1** (classe di motivi PPxY; **solo PPPY saggiato**) **non** determina la gravità; il dominio **SDR** sì.
...
**Wording record (BATCH_20260926_MALLARET, 2026-09-26):** the P47T limb and the scope of the WW1 conclusion now carry what PMID 24369382 measures, in the wording a blind locator audit passed in four rounds (`research/locator_audits/2026-09-26_PMID24369382_blind_audit.md`): protein abundance judged by eye in one patient's fibroblasts, not quantified; binding lost to one PPPY peptide in vitro. Post-audit edits, each taken from an auditor's note and declared here: *al 2014* for the ages (round-4 note 3); *in costrutti di fusione GST-WW* in `CLAIM 033` (round-4 note 2); *cinque varianti (dati su cellule di paziente e saggi in vitro)* for the lead, and *proteina non rilevata al Western blot* for Q230P in `CLAIM 033` (Mirror review, aligning with the `DETECTION_FLOOR` premise above and `CLAIM 019`). The claim's conclusion, its cross-paper construction and its status are unchanged.
---
...
## CLAIM 032
**Title:** WWOX haploinsufficiency is not deleterious **on the endpoints that have been measured** (neoplasia, lifespan, growth, gross morphology): the therapeutic threshold is well below full restoration **for those endpoints**
**Status:** in observation
...
**Transferability:** T1/T2
**clinical relevance:** VERY HIGH
**Summary:** La perdita di **un solo** allele di WWOX **non produce fenotipo sugli endpoint finora misurati** — neoplasia spontanea, lifespan, crescita, morfologia macroscopica, Western blot/immunoistochimica, e osservazione clinica delle famiglie. 🔴 **Nessuna delle fonti misura cognizione, EEG o eccitabilità di rete, e nessun portatore umano pubblicato ha una valutazione neurologica o neuropsicologica sistematica** (`PREMISE: NOBODY_LOOKED`). **Lo stato dell'evidenza è quindi «insufficiente per una conclusione generale di assenza di fenotipo», non «fenotipo assente».** ⚠️ Questo **non dimostra** una patologia nei portatori: l'aploinsufficienza resta compatibile con sopravvivenza, crescita e morfologia normali, e ogni genitore portatore pubblicato resta clinicamente bene. Aldaz 2014: *"loss of one Wwox allele (i.e. **haploinsufficiency**) appears **not to be deleterious**"*; *"the lifespan of the Wwox heterozygotes was **indistinguishable from WT mice**"*. Tochigi 2019: i ratti **`+/lde`** hanno *"a single band of normal molecular weight, but its intensity was **almost half**"*, con immunoistochimica corticale intensa come i `+/+` e **assente** nei `lde/lde`. Ogni famiglia umana pubblicata (Shaukat, Elsaadany, Abdel-Salam, Mallaret, Johannsen) ha **genitori portatori eterozigoti sani**. Inoltre, il topo **ipomorfo** `Wwox^gt/gt` (proteina bassa **ma rilevabile**) è **vitale**, mentre il null muore a 3-4 settimane ⇒ **la soglia fra letale e vitale sta sotto il 50%**.
**Clinical meaning:** Ridefinisce la **soglia di successo di ogni leva del portafoglio**, **per gli endpoint su cui la soglia è nota**. (1) **Correggere o compensare un solo allele basta — per quegli endpoint**, in linea di principio: the reference genotype diventerebbe l'equivalente funzionale di un portatore sano. (2) **Non serve efficienza elevata**: terapia genica, base/prime editing e chaperoni hanno rese modeste in vivo e non raggiungono ogni cellula — se l'aploinsufficienza è tollerata, **un mosaicismo terapeutico parziale può bastare**. (3) Il principio "il parziale conta" acquisisce un **fondamento quantitativo**, non retorico. ⚠️ **Limiti che vietano di estrapolare:** la soglia è nota per **sopravvivenza e morfologia**, **non per cognizione ed epilessia** — nessuno ha misurato quanta WWOX serva al neurosviluppo; l'aploinsufficienza è tollerata **dalla nascita**, mentre un rescue nel genotipo di riferimento arriverebbe **dopo** parte del danno di sviluppo (vedi [[claim_registry_current#CLAIM 031]]); nei topi eterozigoti è documentato un aumento di tumorigenicità **sotto carcinogeni**. **Non è parere medico.**
...
**(1) La classificazione è sintattica, non funzionale.** La classe è dedotta dal *tipo di lesione nel DNA*, mai dall'effetto misurato sulla proteina. Le nostre stesse fonti la falsificano come proxy: **Q230P** è missense e ha proteina **non rilevata** al Western blot ([[paper_registry_current#PAPER 041]]); **P47T** è missense, ha **proteina presente, di abbondanza simile ai controlli all'ispezione visiva (non quantificata)**, binding in vitro al peptide PPPY **perduto** in costrutti di fusione GST-WW, e un fenotipo SCAR12 che gli autori descrivono come **più lieve** dei modelli murino e di ratto ([[paper_registry_current#PAPER 042]]); **P47R** — stesso residuo — dà fenotipo **severo**. Dentro "missense" convivono almeno tre meccanismi distinti. Vedi [[claim_registry_current#CLAIM 030]].
...
## CLAIM 037
**Title:** Seizure-related phenotypes in WWOX rodent models are documented in the rat `lde/lde` (audiogenic + EEG), in the **Wwox-null mouse** (behaviourally since 2020, electrographically since 2026) and in the **`Wwox^P47T/P47T` knock-in mouse** (video-EEG, adult); the **audiogenic/kindling** phenotype remains rat-specific
**Status:** in observation
**Type:** DATO
...
**Evidence boundary:** 🔴 **`NOT_REPORTED ≠ ABSENT`, and the old negative was a survey artefact.** PMID 19500159 asserts three times, and formalises in a Table 2 whose `Epilepsy` row is filled only for `lde/lde`, that Wwox-null mice show no epilepsy — but it is a **literature survey over four papers none of which performed any electrographic or scored behavioural seizure measurement** (PMID 17360458 silent; PMID 18487609 a *behavioural* negative; PMID 19936220 measures no seizure endpoint at all, its only brain measurement being organ weight; PMID 19500159 itself did not record mice). **None of the four is an electrographic negative, because none of the four recorded**, and the survey predates the NCKU null entirely. 🔴 **The clause *«i topi potrebbero morire prima di convulsionare»* is DELETED as falsified:** the NCKU null survives *"less than a month"* and shows **spontaneous seizures from postnatal day 12** (PMID 32000863), and the null shows **SWDs at P14–P21** (PMID 42422765) — both **inside** its lifespan. ⚠️ **Do not read this as EEG normality anywhere else:** no continuous recording exists for the Aldaz/EIIA null, `Wwox^+/−`, `Nes-Cre`, `Syn-Cre`, or any null outside P14–P21. ⚠️ **Species and alleles stay separate:** the rat data below are `lde/lde`; the mouse spontaneous and provoked data are the **NCKU WD1/WD234** nulls; the video-EEG data are the **`P47T` knock-in, which is not a null**. Four phenomena, four methods, three genotypes, two species. 🔴 **`audiogenic` is DOCUMENTED rat-specific and ASSERTED for the mouse at abstract depth only, and the distinction is load-bearing.** PMID 24369382 (Mallaret 2014, *Brain*, **Aldaz co-author** — the knockout mouse's own laboratory) states in its abstract *«we observed that the short-lived Wwox knock-out mouse display spontaneous and audiogenic seizures»*, and a scientific commentary in the same journal independently transmits *«knockout mice displayed audiogenic seizures»*. ⛔ **Neither is a measurement this repository can inspect:** `get_full_text_article(pmc_ids=["PMC3914474"])` was attempted on 2026-09-22 and returned **`full_text: ""`** — the body is not served by any route available here, so **there is no `n`, no strain, no stimulus protocol and no control to read.** And **no Wwox mouse of any allele has ever been audiogenically provoked in any inspectable method** (`PREMISE: NOBODY_LOOKED`; the only provocation ever applied to a Wwox mouse is chemoconvulsant). **The assertion is recorded, not promoted** — the `LIT-0405` precedent governs. `REVIVAL_TRIGGER`: acquisition of PMID 24369382's body, **or** any audiogenic-provocation experiment on a Wwox mouse. 🔵 **The rat evidence and every caveat on it are unchanged:** 2–3 settimane nel topo contro **3–12 settimane** nel ratto, con esordio più precoce delle crisi al giorno 16. ⚠️ Il 95% audiogeno è **solo femminile**, dichiarato unicamente nella didascalia della Fig. 6. ⚠️ Il 34% spontaneo è **un pavimento, non un tasso**: gli autori dichiarano che crisi non rilevate e morte precoce lo spingono in basso. ⚠️ La vacuolizzazione **non ha corrispettivo** in epilessia umana né in altri modelli animali, il che limita il trasferimento. ⚠️ Due soli paper, **un solo laboratorio, mai replicati indipendentemente** — mitigato dal fatto che il fenotipo fu osservato **prima** che il gene fosse identificato. 🔴 `PREMISE: DEFAULT_FROM_TEXTBOOK` — la scomparsa della proteina mutante è attribuita al sistema ubiquitina-proteasoma **senza alcun saggio di turnover, inibitore o determinazione di via**; è lo stesso default falsificato il 2026-07-12 per un altro allele WWOX, il cui turnover passava per una via lisosomiale HSC70-associata insensibile a MG-132. **`REVIVAL_TRIGGER`:** un chase con cicloesimide più inibitori proteasomali versus lisosomiali/CMA sulla proteina lde.
...
## CLAIM 039
**Title:** Ataxic gait is the most penetrant phenotype of the rat `lde/lde` model — 95% versus 0% — and **no marked cerebellar histopathology was detected on light microscopy at ~28 days**
**Status:** in observation
**Type:** DATO
...
**Evidence boundary:** L'atassia **non ha spiegazione strutturale** in questo paper: il cervelletto è istologicamente indenne e nessun'altra regione, oltre a ippocampo e amigdala, mostra alterazioni al microscopio ottico. Non sono stati eseguiti test motori quantitativi (rotarod, footprint, analisi cinematica): la valutazione è osservazionale e non in cieco. Nessun dato su progressione temporale. 🔴 **Narrowing 2026-09-21 — nessuno dei due flussi di evidenza stabilisce né esclude oggi un contributo cerebellare.** (a) **L'esclusione poggia su una sola frase coperta da modale**, in Discussion: *"we did not detect any **marked** pathologic changes in the cerebella of `lde/lde` rats"* — un'osservazione al microscopio ottico, **non in cieco**, di cui n, età, colorazione e piano di sezione non sono registrati in nessuno dei **32 locator** enumerati; e **nessun test motorio quantitativo esiste in quella fonte** (l'osservazione dell'andatura atassica sta nella sezione di osservazione delle crisi, non in una batteria motoria). `PREMISE: LIGHT_MICROSCOPY_FLOOR`. Il paper è privo di DOI e PMCID e non è ottenibile in questo ambiente, quindi quei parametri non sono recuperabili. (b) **Evidenza contro-direzionale, stesso ceppo e stessa colonia:** [[paper_registry_current#PAPER 020]] (`PMID 32581702`) riporta a **P1** che *"the development of cerebellum was delayed … as shown by reduced number of foliation"*. ⚠️ È **una frase di passaggio, senza numero, n=3, non in cieco**, e **non era stata catturata come locator** al momento della lettura — secondo caso dello stesso difetto di propagazione già registrato su [[claim_registry_current#CLAIM 016]]. (c) **Le due misure sono compatibili fra loro**: le età sono disgiunte (P1 vs ~28 giorni) e un ritardo di sviluppo a P1 non deve lasciare una patologia *marcata* a 28 giorni — ed è esattamente per questo che il silenzio a 28 giorni non è mai stato evidenza di normalità cerebellare. 🔴 **Nessuna delle due, né insieme, stabilisce una relazione causale fra cervelletto e fenotipo funzionale.** `REVIVAL_TRIGGER`: un endpoint cerebellare quantitativo in questo ceppo — conta di cellule del Purkinje, indice di foliazione, spessore dello strato molecolare — oppure una batteria motoria. ⚠️ **Questa claim resta una claim sul MODELLO RATTO.** Il materiale di neuroimaging umano discusso altrove nel repository **non è integrato qui**: è di livello abstract, formulato dagli autori come *"We suggest"*, e contestato da una lettura integrale indipendente.
...
## CLAIM 040
**Title:** Neuronal restoration of WWOX suppresses spike-wave discharges in the `Wwox`-null mouse to a level statistically indistinguishable from wild type
**Status:** in observation
**Type:** DATO
**Pathway:** P1 — neurosviluppo; P7 — eccitabilità di rete
**Genotype/model relevance:** murino, **`Wwox`-null** (allele del primario), pup P14→P21; **non** un allele missenso umano e **non** il ratto `lde/lde`
**Transferability:** T2 — la triade genotipo→fenotipo→rescue è il disegno causale più forte del corpus, ma l'endpoint è elettrografico di tipo assenza, non convulsivo
**clinical relevance:** MODERATE
**Summary:** ECoG continua 24/7 per 7 giorni consecutivi, impianto a P14, canale singolo epidurale corticale destro con riferimento controlaterale, scoring **in cieco** e sottoinsieme validato contro video sincronizzato. I pup `Wwox`-KO mostrano un numero di **SWD** significativamente superiore ai WT; i pup riscattati con AAV9-hSynI-hWWOX (HD) mostrano una riduzione marcata. Statistica sui contrasti: `****` WT-vs-KO, `****` KO-vs-HD, **`ns` WT-vs-HD** — cioè il rescue riporta l'endpoint a un livello non distinguibile dal wild-type. `n = 5` pup per gruppo.
**Clinical meaning:** **Nessuna implicazione terapeutica diretta e nessun parere medico.** È il braccio di prova che il fenotipo è causalmente attribuibile alla perdita di WWOX neuronale, non una proposta di trattamento.
**Evidence boundary:** ⚠️ `n = 5` per gruppo. ⚠️ **Canale singolo**: non può distinguere una scarica generalizzata da un artefatto focale, né valutare la sincronia bilaterale — il montaggio a quattro canali bilaterale esiste altrove nel corpus (`P47T`, video-EEG) e **non** è stato usato qui. ⚠️ L'acquisizione comincia *«immediately after surgery … without a recovery interval»*, quindi le prime ore portano stato post-anestetico. ⚠️ La registrazione parte da **P14**: **l'esordio sotto P14 non è vincolato** — è un pavimento di osservazione, non un'età di esordio. ⚠️ I Methods dichiarano media ± SD mentre la legenda di Figura 7 dichiara media ± SEM. 🔴 **L'endpoint dei picchi interictali della stessa figura NON è testato:** il pannello 7C stampa `0.2000` sul confronto WT-vs-KO, che è **esattamente il pavimento** di un Mann–Whitney a due code alle numerosità rappresentate (U = 0, p = 2/C(5,2) = 0.2000) — il test **non può restituire meno**. Il testo corrente lo definisce *«a significant elevation»*, che **sovradichiara**; leggere `0.2000` come *«nessun effetto»* è lo stesso errore con il segno invertito. **`0.2000` qui significa «non testato».** `PREMISE_TAG: DEFAULT_FROM_TEXTBOOK` su *«p > 0.05 significa nessun effetto»*. 🔴 **SWD è una firma elettrografica di tipo assenza e non è sinonimo di «crisi»:** non rappresenta i tipi convulsivi della WOREE umana (tonico, clonico, tonico-clonico, mioclonico, spasmi infantili, assenza). **Non generalizzare a un altro allele, a un'altra età o a un'altra specie.**
**Source:** [[paper_registry_current#PAPER 011]] (PMID 42422765), Figura 7E; lettura di pannello da raster con impronta digitale, mai da testo
...
**Impact on Working Model:** nessun cambio BLOCCO 1, nessuna raccomandazione terapeutica. Estrae dalla sottoclausola di una claim di terapia genica la **sola triade genotipo→fenotipo→rescue su un endpoint vicino alle crisi** esistente nel corpus, e la registra con i suoi limiti.
