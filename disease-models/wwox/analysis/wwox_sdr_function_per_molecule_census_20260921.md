...
|---|---|---|---|
| **1** ⭐ | **Corresponding author, still active** | **Andrzej K. Bednarek — `andrzej.bednarek@umed.lodz.pl`**, Department of Molecular Carcinogenesis, Medical University of Łódź, Żeligowskiego 7/9, 90-752 Łódź, Poland. *(Address and e-mail as published in PMID 40327201, 2025, and PMID 35290621, 2022.)* | Last author of the target paper and **still publishing on WWOX in 2025–2026**. The highest-yield route by a wide margin |
