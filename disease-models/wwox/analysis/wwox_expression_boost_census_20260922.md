...
| A3 | **5-aza-2'-deoxycytidine (AZA)** | DU145 / LNCaP / PC-3 prostate lines | **human prostate cancer lines** | human | ↑ | *"most strikingly in DU145"* — no number | RT-PCR + Western | **transcript AND protein** | `DIRECTLY MEASURED` (PMID **16818616**, [DOI](https://doi.org/10.1158/0008-5472.CAN-06-0288)) |
| A4 | **5-aza-2'-deoxycytidine** | breast-cancer lines in vitro; **intratumoral injection** in nude mice | **human breast cancer lines** | human / mouse host | ↑ | not quantified in abstract; *"Alteration of global methylation levels was **not** observed"* | IHC/blot + xenograft growth | **protein** | `DIRECTLY MEASURED` (PMID **17019711**, [DOI](https://doi.org/10.1158/1078-0432.CCR-06-1102)) |
| A5 | **5-aza-2'-deoxycytidine (AZA)** | intrahepatic cholangiocarcinoma lines, in vitro **and** in vivo (xenograft) | **human ICC lines** | human / mouse host | ↑ | *"used to **activate the endogenous WWOX gene**"* — no magnitude in abstract | qRT-PCR, immunoblot, IF, IHC, MSP | **transcript + protein** | `DIRECTLY MEASURED` (PMID **25168293**, [DOI](https://doi.org/10.1111/jgh.12683)) |
| A6 | **5-aza-2'-deoxycytidine** | 9 pancreatic-cancer lines | **human pancreatic cancer lines** | human | ↑ | *"demonstrated **an increase** in the expression of WWOX"*; hypermethylation present in only **2/9** lines | MSP + real-time RT-PCR | **transcript** | `DIRECTLY MEASURED` (PMID **15073125**, [DOI](https://doi.org/10.1158/1078-0432.ccr-0899-3)) |
| A7 | **5-aza-dC ± TSA** | SNU-719 (EBV+) and SGC-7901 / BGC-823 / AGS gastric lines | **human gastric carcinoma lines** | human | ↑ (one of five genes assayed) | not separated per gene in abstract | MSP + qRT-PCR | **transcript** | `DIRECTLY MEASURED` (PMID **25720522**, [DOI](https://doi.org/10.1007/s12032-015-0486-1)) |
| A8 | **5-aza-dC + trichostatin A (combination)** | HSC-59 gastric line (hypermethylated) | **human gastric carcinoma line** | human | ↑ | *"**restored endogenous WWOX expression levels** in HSC-59 cells"* — no number | RT-PCR + Western | **transcript and/or protein** (abstract does not separate) | `DIRECTLY MEASURED` (PMID **20737170**, [DOI](https://doi.org/10.1007/s00428-010-0961-1)) |
| A9 | **AZA (± HDACi) protocol** | H1299 lung-cancer xenografts | **human lung cancer line in mouse** | human / mouse host | ↑ (asserted) | none given; the paper's **measured** arm is a *conditional transgene*, not the drug | xenograft growth; expression endpoint not specified in abstract | **not separable from abstract** | `AUTHOR INTERPRETATION` pending full text (PMID **17200365**, [DOI](https://doi.org/10.1002/ijc.22403)) |
...
5. **The readout that must be built into whatever comes first.** Any future boost experiment on this
