...
|---|---|---|---|
| **30202070** | Schultz 2018, *Nat Commun* — NPC1 `I1061T` degradation in primary patient fibroblasts. **The source of the bafilomycin finding, and the only load-bearing paper in `D-26`.** | 🟢 **body read in full this session by the Orchestrator**, CC BY — ✅ **receipt persisted same day: `FTR-20260922-30202070-01`, `partial_fulltext_read`, six verbatim locators.** Ledger 189, tail anchored | **CLEARED.** `D-26` unblocked. Depth is `partial` because the route strips every figure number |
