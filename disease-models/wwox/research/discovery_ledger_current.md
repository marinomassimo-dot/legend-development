...
- **Interconnessioni:** `DL-METH-091` (**forma forte falsificata, non cancellata**) · `DL-METH-093` · `IMPORTED_PREMISE_ATTRIBUTION_GATE` · [[epistemic_discipline]] · `FT-062`.
...
- **Interconnessioni:** `FT-057` (il KO murino, di cui questo paper riporta di seconda mano la morte metabolica inspiegata) · `FT-063` · `DL-METH-094` · [[gold_is_in_the_details]].
