...
- 🔵 **Append-only, 2026-09-26 (`BATCH_20260926_ALDAZ`) — il «B» di questa mappa è più stretto nel modello che la voce propone come piattaforma.** Nel topo `Wwox^P47T/P47T` (PMID 36828035) la gliosi quantificata per immunoistochimica è **ippocampale** (nel cervelletto il paper misura solo mRNA di citochine, senza confronto fra età); l'astrogliosi cresce con l'età, la microglia peggiora con l'età solo nella **morfologia**, e se la sua **abbondanza** progredisca non è stato testato. Un esperimento che misuri Iba1 come readout di progressione misura quindi un asse che il paper di riferimento non ha mostrato progressivo. Vedi [[claim_registry_current#CLAIM 006]]. **Nessun altro contenuto di questa voce è modificato.**
...
- 🔵 **Append-only, 2026-09-26 (`BATCH_20260926_ALDAZ`) — la gamba cerebrale di questa voce è più stretta di come è scritta.** Nel topo `Wwox^P47T/P47T` la gliosi quantificata per immunoistochimica (conteggi e frazioni d'area Gfap⁺/Iba1⁺) è **ippocampale** (CA1, CA3, DG); nel cervelletto il paper misura la degenerazione delle cellule di Purkinje e un aumento ≥ 2 volte degli mRNA di IL1β e TNFα (qRT-PCR, n = 6 per gruppo, Fig. 9d–e), senza confronto fra età. L'astrogliosi cresce con l'età; per la microglia la progressione è mostrata **solo nella morfologia**, e la progressione dell'**abbondanza** non è stata testata (nessun confronto 80 vs 250 giorni), il che non equivale a un'assenza. Statistiche su subfield/cellule di n = 3 topi. Vedi [[claim_registry_current#CLAIM 006]]. **Nessun altro contenuto di questa voce è modificato.**
