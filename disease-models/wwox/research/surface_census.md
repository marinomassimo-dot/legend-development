...
| PMID 24871327 | FT-039 | `structured` | `clean` | PMID24871327_Iatan2014_PMC.html |
...
| PMID 15070730 | — | `pdf_only` | `SUSPECT` — contains the C0 control U+0001 | PMID15070730_Aqeilan2004.pdf |
...
| PMID 26256646 | — | `structured` | `clean` | PMID26256646_DelMare2015_PMC.xml |
...
| PMID 27308416 | — | `structured` | `clean` | PMID27308416_AbuRemaileh2015_PMC.xml |
| PMID 27308504 | — | `structured` | `clean` | PMID27308504_Hazan2015_PMC.xml |
| PMID 27550453 | — | `structured` | `clean` | PMID27550453_DelMare2016_PMC.html |
| PMID 27551470 | — | `structured` | `clean` | PMID27551470_Hazan2015_PMC.xml |
| PMID 29724996 | — | `structured` | `clean` | PMID29724996_AbuRemaileh2018_PMC.xml |
| PMID 30082886 | — | `structured` | `clean` | PMID30082886_Abdeen2018_PMC.xml |
| PMID 30370248 | — | `structured` | `clean` | PMID30370248_Tanna2018_PMC.xml |
...
| PMID 34831305 | — | `structured` | `clean` | PMID34831305_Steinberg2021_PMC.xml |
