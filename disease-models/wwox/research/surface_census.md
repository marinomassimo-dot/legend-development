...
**Corpus:** `fulltext` — 136 entries, 77 papers, listing digest `5d4db9711422ea34`  
...
|---|---:|---|
| `structured` | 56 | publisher XML/HTML present — read this one (rule 5d) |
| `pdf_only` | 21 | no structured surface locally — acquire XML/HTML before reading |
...
|---|---:|---|
| `SUSPECT` | 16 | the text carries a known corruption signature — do not quote it; adjudicate against the rendered page, or re-acquire the paper structured |
| `clean` | 61 | no known signature found — this is not a verification |
| `not_screened` | 0 | no deterministic extractor available, or extraction failed |

🔴 **16 of the 21 PDF-only papers cannot be read from their text layer at all**, and all of them should be acquired as XML/HTML rather than read from the PDF. A `clean` PDF is still a PDF: `deepdive_manifest` refuses it as a text surface, and a locator drawn from one has to be anchored to the page.
...
| PMID 38182577 | FT-011 | `structured` | `clean` | PMID38182577_Akkawi2024.pdf, PMID38182577_Akkawi2024_PMC.xml |
...
| PMID 17360458 | FT-032 | `structured` | `clean` | PMID17360458_Aqeilan2007.pdf, PMID17360458_Aqeilan2007_PMC.html |
...
| PMID 24871327 | FT-039, FT-039, FT-046, FT-049 | `structured` | `clean` | PMID24871327_Iatan2014_PMC.html |
...
| PMID 15070730 | FT-046 | `structured` | `clean` | PMID15070730_Aqeilan2004.pdf, PMID15070730_Aqeilan2004_PMC.html |
...
| PMID 18487609 | — | `structured` | `clean` | PMID18487609_Aqeilan2008.pdf, PMID18487609_Aqeilan2008_PMC.html |
| PMID 18674750 | — | `structured` | `clean` | PMID18674750_Lee2008.pdf, PMID18674750_Lee2008_PMC.html |
| PMID 21731849 | — | `structured` | `clean` | PMID21731849_DelMare2011.pdf, PMID21731849_DelMare2011_PMC.html |
| PMID 23370280 | — | `structured` | `clean` | PMID23370280_Salah2013.pdf, PMID23370280_Salah2013_PMC.xml |
| PMID 24510053 | — | `pdf_only` | `SUSPECT` — contains the C0 control U+0002 | PMID24510053_Aqeilan2014.pdf |
| PMID 24550385 | — | `structured` | `clean` | PMID24550385_AbuOdeh2014.pdf, PMID24550385_AbuOdeh2014_PMC.html |
...
| PMID 25331887 | — | `structured` | `clean` | PMID25331887_AbuOdeh2014.pdf, PMID25331887_AbuOdeh2014_PMC.html |
...
| PMID 26675548 | — | `structured` | `clean` | PMID26675548_AbuOdeh2016.pdf, PMID26675548_AbuOdeh2016_PMC.xml |
...
| PMID 38499540 | — | `structured` | `clean` | PMID38499540_BidanyMizrahi2024.pdf, PMID38499540_BidanyMizrahi2024_PMC.xml |
...
**Accounting.** Rows: 77 corpus papers + 71 queued papers − 42 in both = **106** emitted. ✓ Entries: 45 resolved + 5 unjoined = **50** queue entries. ✓
